...
func (rl *ramLedger) DataDump(dumpReason int) error {
	return nil
}

func (rl *ramLedger) WriteConfigBlockToSpecFile(block *cb.Block) error {
	return nil
}

func (rl *ramLedger) ReadConfigBlockFromSpecFile() (*cb.Block, error) {
	return nil, fmt.Errorf("The ledger type of orderer is ram, cannot read config block from file")
}
